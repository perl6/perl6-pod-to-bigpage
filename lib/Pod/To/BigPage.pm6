...
sub compose-before-content ( Array $pod ) is export {
    my @h1 =  $pod[0].contents.grep( * ~~ Pod::Heading).grep( *.level == 1 );
    compose-before-content( @h1?? @h1[0].contents[0].contents !! "Generated by Pod::To::BigPage" );
}

sub compose-before-content ( Str $title ) is export {
